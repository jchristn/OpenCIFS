...
function Remove-RemoteShareConnection {
    ...
    cmd /c ("net use `"{0}`" /delete /y" -f $RemotePath) | Out-Null
}
...
try {
    Remove-TestMapping
    Remove-RemoteShareConnection -RemotePath "\\127.0.0.1\share"
    Remove-RemoteShareConnection -RemotePath "\\localhost\share"
